...
function Connect(props) {
    ...
    return (
        <div className="container">
            ...
            <a id="linkedin" className="connect-logo connect-button" href={props.linkedin} target="_blank" rel="noopener noreferrer">
            ...
            <a id="github" className="connect-logo connect-button" href={props.github} target="_blank" rel="noopener noreferrer">
            ...
            <a id="gmail" className="connect-logo connect-button" href={props.contact}>
            ...
            <a id="resume" className="connect-logo" href={props.resume} target="_blank" rel="noopener noreferrer">
                    <svg
                        version="1.1"
                        id="_x32_"
